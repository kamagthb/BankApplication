Feature: Navigation on Pages
  ...
  Scenario:Account Summary page connection
    ...
    Then Page title should be changed to "Zero - Account Summary"
  ...
  Scenario:Account Activity page connection
    ...
    Then Page title should be changed to "Zero - Account Activity"
  ...
  Scenario: Pay Bills page connection
      ...
      Then Page title should be changed to "Zero - Pay Bills"
